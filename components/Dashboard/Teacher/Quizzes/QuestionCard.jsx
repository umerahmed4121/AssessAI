    ...
    return (
        <div className='w-full bg-primary-light my-2 p-2 rounded-md border border-primary-light-2'>
            <div className='grid grid-cols-3 justify-items-end items-center'>
                ...
                <div className=' w-full p-2 flex flex-row justify-center items-center gap-2 h-fit'>
                    <div>Marks</div>
                    <input
                    className='bg-primary-light p-1 border border-primary-light-2 rounded-md focus:outline-none text-white placeholder:italic text-center'
                    type="number"
                    value={totalMarks}
                    min={1}
